...
const STATIC_QUESTS_RAW: QuestDefinition[] = [
  ...
  {
    id: 'quest-8-own-level-two-vehicle',
    title: 'Upgrade Your Vehicle',
    description: 'Own a level 2 vehicle or better.',
    reward_money: 600,
    reward_gems: 0,
    target_screen: 'stuff',
    condition: { type: 'owned_car_level_at_least', level: 2 },
  },
  {
...
const STATIC_QUEST_CHAPTER_OVERRIDES: Partial<Record<string, number>> = {
  ...
  // Chapter 1 — Getting Started (7 quests)
  'quest-8-own-level-two-vehicle':     1,
  ...
  'quest-32-claim-earnings-three-times': 1,
  // Chapter 2 — Building Momentum (8 quests)
  'quest-17-buy-first-investment':     2,
  'quest-18-upgrade-first-investment': 2,
  ...
  // Chapter 3 — Growing Empire (9 quests)
  ...
  'quest-37-investment-level-3':       3,
  // Chapter 4 — Passive Income (8 quests)
