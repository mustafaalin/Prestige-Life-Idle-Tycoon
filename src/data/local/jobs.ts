...
export const MANAGER_JOBS: Job[] = createJobCollection('manager', 41, [
  { slug: 'team-leader', name: 'Team Leader', description: 'Lead a small team, coordinate delivery, and keep daily work on track.', hourly_income: 22000, is_default_unlocked: false, icon_url: null, prestige_points: 392 },
  { slug: 'shift-supervisor', name: 'Shift Supervisor', description: 'Oversee shift performance, staffing, and daily operational flow.', hourly_income: 23000, is_default_unlocked: false, icon_url: null, prestige_points: 406 },
  { slug: 'operations-supervisor', name: 'Operations Supervisor', description: 'Monitor workflows, quality, and cross-team execution standards.', hourly_income: 24300, is_default_unlocked: false, icon_url: null, prestige_points: 420 },
  { slug: 'office-manager', name: 'Office Manager', description: 'Run office operations, schedules, and administrative systems smoothly.', hourly_income: 25600, is_default_unlocked: false, icon_url: null, prestige_points: 435 },
  { slug: 'project-coordinator', name: 'Project Coordinator', description: 'Coordinate timelines, owners, and milestones across active projects.', hourly_income: 26900, is_default_unlocked: false, icon_url: null, prestige_points: 450 },
  { slug: 'assistant-manager', name: 'Assistant Manager', description: 'Support department performance, hiring, and day-to-day team decisions.', hourly_income: 28300, is_default_unlocked: false, icon_url: null, prestige_points: 466 },
  { slug: 'department-supervisor', name: 'Department Supervisor', description: 'Supervise a larger unit, improve output, and handle escalations.', hourly_income: 29700, is_default_unlocked: false, icon_url: null, prestige_points: 482 },
  { slug: 'service-manager', name: 'Service Manager', description: 'Own service quality, customer outcomes, and team accountability.', hourly_income: 31100, is_default_unlocked: false, icon_url: null, prestige_points: 499 },
  { slug: 'production-manager', name: 'Production Manager', description: 'Manage production targets, efficiency, and resource planning.', hourly_income: 32500, is_default_unlocked: false, icon_url: null, prestige_points: 516 },
  { slug: 'sales-manager', name: 'Sales Manager', description: 'Drive revenue strategy, coach sales reps, and grow regional targets.', hourly_income: 34000, is_default_unlocked: false, icon_url: null, prestige_points: 534 },
  { slug: 'marketing-manager', name: 'Marketing Manager', description: 'Lead campaigns, positioning, and brand growth across channels.', hourly_income: 35500, is_default_unlocked: false, icon_url: null, prestige_points: 552 },
  { slug: 'hr-manager', name: 'HR Manager', description: 'Manage recruiting, people operations, and long-term talent health.', hourly_income: 37000, is_default_unlocked: false, icon_url: null, prestige_points: 571 },
  { slug: 'finance-manager', name: 'Finance Manager', description: 'Own budgets, controls, and financial planning for the business.', hourly_income: 38500, is_default_unlocked: false, icon_url: null, prestige_points: 590 },
  { slug: 'it-manager', name: 'IT Manager', description: 'Lead infrastructure, support operations, and systems reliability.', hourly_income: 40100, is_default_unlocked: false, icon_url: null, prestige_points: 610 },
  { slug: 'operations-manager', name: 'Operations Manager', description: 'Scale operational systems and align teams around execution goals.', hourly_income: 41700, is_default_unlocked: false, icon_url: null, prestige_points: 630 },
  { slug: 'engineering-manager', name: 'Engineering Manager', description: 'Guide technical teams, planning, and delivery of larger initiatives.', hourly_income: 43300, is_default_unlocked: false, icon_url: null, prestige_points: 651 },
  { slug: 'senior-manager', name: 'Senior Manager', description: 'Own multi-team performance and make higher-level strategic calls.', hourly_income: 44900, is_default_unlocked: false, icon_url: null, prestige_points: 672 },
  { slug: 'director', name: 'Director', description: 'Set organizational direction and lead entire functions at scale.', hourly_income: 46600, is_default_unlocked: false, icon_url: null, prestige_points: 694 },
  { slug: 'general-manager', name: 'General Manager', description: 'Run a major business unit with full performance responsibility.', hourly_income: 48300, is_default_unlocked: false, icon_url: null, prestige_points: 717 },
  { slug: 'ceo', name: 'CEO', description: 'Lead the company vision, strategy, and top-level business outcomes.', hourly_income: 50000, is_default_unlocked: false, icon_url: null, prestige_points: 740 },
]);
