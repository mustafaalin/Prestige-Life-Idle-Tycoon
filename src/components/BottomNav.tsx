          ...
          return (
            <button
              ...
              className="
                ...
                flex-1 border-2 bg-white/20 border-white/40
                hover:bg-cyan-300/40 hover:border-cyan-200 hover:scale-105 hover:shadow-lg
            ...
            >
              ...
              />
              <span className="text-[10px] font-black transition-all duration-200 uppercase tracking-tight text-teal-900">
                {item.label}
              </span>
            </button>
          );
