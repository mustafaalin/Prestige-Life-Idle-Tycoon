...
export function Header({
  ...
  return (
    <header className="bg-gradient-to-br from-sky-500/65 via-cyan-600/80 to-blue-700/80 backdrop-blur-xl text-white shadow-2xl relative overflow-hidden w-full border-b border-white/30 z-20">
        ...
        <div className="flex w-full items-center gap-2">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <div className="flex flex-col items-end gap-1">
              <div className="flex items-center gap-1.5 bg-white/12 px-2 py-1 rounded-lg min-w-[76px] justify-center">
